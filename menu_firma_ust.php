...
<ul id="mb1">
    ...
    <li id="menufirmy"><a data-icon="ui-icon-suitcase" href="/admin112014_firmy.php"  style="width: 120px;">Firmy</a>
        <ul>
            <li>
                <a data-icon="ui-icon-note" onclick="noweszkolenieust();"  style="width: 120px;">Nowe ustawienie</a>
            </li>
        </ul>
    </li>  
    <li><a data-icon="ui-icon-document" href="/admin112014_szkolenia.php"  style="width: 120px;">Szkolenia</a>
    </li>  
