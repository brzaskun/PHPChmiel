...
<html lang="pl">
    ...
    <head>
        ...
        <script src="/resources/ckeditor/adapters/jquery.js?v190529"></script>
        <script src="/resources/primeui-4.1.12/primeui.min.js?v190529"></script>
        <script src="/resources/js/admin_112014_szkolenia.js?v190529"></script>
       ...
       <script>
              $(document).ready(function() {
                ...
                var tabela = $("#tabszkolenie").dataTable();
    ...
    <body>
        <?php
            include_once './menu_szkolenia.php';
        ?>
        <div id="notify"></div>
        <?php
            include_once './admin_szkolenie112014.php'; 
        ?>
    </body>
</html>
