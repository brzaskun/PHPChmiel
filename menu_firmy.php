...
<ul id="mb1">
    ...
    <li id="menufirmy"> <a data-icon="ui-icon-suitcase" href="/admin112014_firmy.php"  style="width: 110px;">Firmy</a>
         <ul>    
            <li><a data-icon="ui-icon-plus" onclick="nowyzaklad();">Dodaj nową firmę</a></li>
            <li><a data-icon="ui-icon-arrowthick-2-e-w" href="/admin112014_firma_ust.php">Firma - szkolenie</a></li>  
         </ul>
    </li>
