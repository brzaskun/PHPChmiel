...
<html lang="pl">
    ...
    <head>
        ...
        <script src="/resources/dataTableNew/media/js/dataTables.jqueryui.js?v190529" type="text/javascript"></script>
        ...
        <script src="/resources/js/require.js?v190529"></script>
        <script src="/resources/js/admin_112014_uzytkownik_grupy.js?v190529"></script>
