...
<ul id="mb1">
    ...
    <li id="menutesty"><a data-icon="ui-icon-circle-check" href="/admin112014_testy.php"  style="width: 110px;">Testy</a>
        <ul>
            <li>
                <a data-icon="ui-icon-note" onclick="nowytestwykaz();">Nowy test</a>
            </li>
        </ul> 
    </li>
