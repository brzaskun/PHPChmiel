...
<ul id="mb1"> 
    ...
    <li  id="menuupowaznieniagrupa"><a data-icon="ui-icon-folder-collapsed" href="/admin112014_uzytkownik_grupy.php"  style="width: 110px;">Up.Grupy</a></li>
    ...
    <li id="menuupowaznienia"><a data-icon="ui-icon-suitcase" href="/admin072017_upowaznienia.php"  style="width: 110px;">Diagnostyka</a></li>
