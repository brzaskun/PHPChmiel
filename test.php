                            ...
                            <table>
                                <tr>
                                    <td style="vertical-align: baseline;">
                                        ...
                                        <span style="text-justify: inter-word;"><?php error_reporting(0);
                echo NextslideTest::$wybranepytania[NextslideTest::$ilosc]['odp1']; ?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <table>
                                <tr>
                                    <td style="vertical-align: baseline;">
                                        ...
                                        <span style="text-justify: inter-word;"><?php error_reporting(0);
                echo NextslideTest::$wybranepytania[NextslideTest::$ilosc]['odp2']; ?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <table>
                                <tr>
                                    <td style="vertical-align: baseline;">
                                        ...
                                        <span style="text-justify: inter-word;"><?php error_reporting(0);
                echo NextslideTest::$wybranepytania[NextslideTest::$ilosc]['odp3']; ?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <table>
                                <tr>
                                    <td style="vertical-align: baseline;">
                                        ...
                                        <span style="text-justify: inter-word;"><?php error_reporting(0);
                echo NextslideTest::$wybranepytania[NextslideTest::$ilosc]['odp4']; ?></span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <script>
                        ...
                        //                        var nazwaciasteczka = "pytanie" +<?php error_reporting(0);
                echo $_SESSION['ilosc'] + 1 ?>;
                        ...
                        (function () {
                            /*odtwarzanie zaznaczonych juz odpowiedzi w przypadku cofniecia sie uzytkownika*/
                            var odpowiedzi = '<?php error_reporting(0);
                echo NextslideTest::przywrocenieodpowiedzi() ?>';
                            if (odpowiedzi !== 'błąd') {
                ...
                echo $_SESSION['ilosc'] + 1 ?>');" style="float: right;" title="Definitywne zakończenie testu i publikacja wyniku"><span class="spanszkolenie">sprawdź</span></button>
                    ...
                    <script>
                        (function () {
                            ...
                            var nrkolejny = <?php error_reporting(0);
                echo $_SESSION['ilosc'] + 1 ?>;
                            var max = <?php error_reporting(0);
                echo $_SESSION['pytaniasize'] ?>;
                            if (nrkolejny < max) {
                                $('#nexttest').show();
                            }
                            if (nrkolejny > 1) {
