...
<html lang="pl">
    <head>
        ...
        <script src="/resources/js/admin_112014_upowaznienie_grupy.js?v190707"></script>
    ...
    <body>
        <div id="notify"></div>
        <?php
        include_once './menu_upowaznienie_grupy.php';
        ?>
        <?php
        include_once './admin_upowaznieniegrupy112014.php';
        ?>
    </body>
</html>
