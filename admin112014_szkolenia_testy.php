...
<!--        <script src="/resources/js/main.js?v190529"></script>
        ...
        <script src="/resources/js/admin_112014_szkolenia_testy.js?v190529"></script>
       ...
       <script>
              $(document).ready(function() {
                ...
                var tabela = $("#tabszkolenietestust").dataTable();
    ...
    <body>
        <?php
            include_once './menu_szkolenia_testy.php';
        ?>
        <div id="notify"></div>
        <?php
            include_once './admin_szkolenie_testy112014.php';
        ?>
    </body>
</html>
