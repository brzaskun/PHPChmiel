...
<!--        <script src="/resources/js/main.js?v190707"></script>
        ...
        <script src="/resources/js/common_generowanietabeli.js?v190707"></script>
        ...
        <script src="/resources/js/admin_112014_szkolenia_wykaz.js?v190707"></script>
    ...
    <body>
        <?php
            include_once './menu_szkolenia_wykaz.php';
        ?>
        <div id="notify"></div>
        <?php
            include_once './admin_szkolenie_wykaz112014.php';
        ?>
    </body>
</html>