...
<ul id="mb1"> 
    <li> <a data-icon=" ui-icon-person" href="/admin112014_uzytkownicy.php"  style="width: 110px;">Użytkownicy</a>  
    </li>  
    <li> <a data-icon="ui-icon-suitcase" href="/admin112014_firmy.php"  style="width: 110px;">Firmy</a></li>  
    <li id="menuzaswiadczenia">  
        <a data-icon="ui-icon-document" href="/admin112014_szkolenia.php"  style="width: 110px;">Szkolenia</a>
        <ul>
            <li>
                <a data-icon="ui-icon-note" onclick="nowezaswiadczeniewykaz();">Nowe zaświadczenie</a>
            </li>
        </ul> 
    </li>  
    <li><a data-icon="ui-icon-circle-check" href="/admin112014_testy.php"  style="width: 110px;">Testy</a></li>
    <li><a data-icon="ui-icon-folder-collapsed" href="/admin112014_uzytkownik_grupy.php"  style="width: 110px;">Up.Grupy</a></li>
    ...
    <li id="menuupowaznienia"><a data-icon="ui-icon-suitcase" href="/admin062018_zaswiadczenia.php"  style="width: 110px;">Zaświadczenia</a></li>
</ul>   
